...
function Pin({ pin }) {
    ...
    const alreadySaved = !!(save?.filter(x => x?.postedBy?._id === user?.sub))?.length
                ...
                <div className="flex justify-between items-center gap-2 w-full">
                    ...
                    )}
                    {
                        postedBy?._id === user?.sub && (
                            ...
                            className="bg-red-white p-2 opacity-70 hover:opacity-100 font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none">
                            <AiTwotoneDelete />
                            </button>
                        )
                    }
